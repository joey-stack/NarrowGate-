...
export function AboutLeadershipSection() {
  ...
  const leaders = [
    ...
    { name: t("l3Name"), role: t("l3Role"), img: "/images/chinwe-ahanonu.webp" },
  ];
  ...
  return (
    <section className="py-20 sm:py-28 bg-[#f2ebd1]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* 6-Card Leadership Grid Layout with Staggered Scroll Entrance */}
        <ScrollStaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
