  ...
  return (
    <section className="py-20 sm:py-28 bg-[#181818] text-white relative overflow-hidden border-t border-b border-white/10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <ScrollReveal>
          {/* Main Card Container */}
          <div className="rounded-2xl bg-[#1E1E1E] border border-white/10 p-6 sm:p-8 lg:p-10 shadow-2xl overflow-hidden relative">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-6">
                ...
                {/* Theme Callout Box */}
                {featured.theme && (
                  <div className="p-4 sm:p-5 rounded-lg bg-white/5 border border-white/10 border-l-4 border-l-[#B91C1C]">
                    <span className="text-xs font-heading font-bold uppercase tracking-wider text-[#B91C1C] block mb-1">
                      {t("themeLabel")}
                    </span>
                    <p className="text-base sm:text-lg font-heading font-bold text-[#F2EBD1] italic">
                      "{featured.theme}"
                    </p>
                    {featured.scripture && (
                ...
                <div className="flex flex-wrap items-center gap-3.5 pt-3">
                  <Link
                    href={`/${locale}/events/${featured.id}`}
                  ...
                  <Link
                    href={`/${locale}/events`}
                    className="px-6 py-3.5 rounded-lg bg-white/10 hover:bg-white/20 text-white font-heading font-semibold text-xs transition-colors duration-200 border border-white/10 inline-flex items-center gap-2"
                  >
