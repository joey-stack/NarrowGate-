    ...
    <div>
      ...
      <section className="py-20 sm:py-28 bg-[#F8F8F8]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Large Hero Banner Image Card (8px radius) */}
          <div className="relative rounded-lg overflow-hidden border border-black/10 shadow-sm min-h-[380px] flex flex-col justify-end group">
            <div 
              ...
              style={{
                backgroundImage: `url('https://framerusercontent.com/images/o6X1ExUxEg9aXlM6PNAcosjw.jpeg')`,
              }}
            />
      ...
      {/* Worship Philosophy Section (8px radius) */}
